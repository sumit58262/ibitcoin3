...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1515274460, 698604, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2555dfa1992928e23fd9748f3be90a3960c4da47481865ed0d88887b809d56e9"));
        assert(genesis.hashMerkleRoot == uint256S("0xb74f5f440516406b1977d8aecc8eaab6ea9a1bcd826d9b1cfc556d421b080450"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("inaurica.com", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.ibitcointools.com", true);
        vSeeds.emplace_back("seed-b.ibitcoin.loshan.co.uk", true);
