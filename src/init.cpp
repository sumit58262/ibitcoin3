...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ibitcoin-project/ibitcoin>";
    const std::string URL_WEBSITE = "<https://ibitcoin.org>";
