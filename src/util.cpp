...
const char * const BITCOIN_CONF_FILENAME = "ibitcoin.conf";
const char * const BITCOIN_PID_FILENAME = "ibitcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ibitcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ibitcoin";
#else
    // Unix
    return pathRet / ".ibitcoin";
#endif
#endif
}
